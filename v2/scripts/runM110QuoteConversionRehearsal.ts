...
async function fixture(client: PoolClient) {
  ...
  await client.query("BEGIN"); try {
    ...
    for (const cap of ["quote.view","quote.create","quote.edit","quote.send","quote.convert"]) await client.query("INSERT INTO v2_permission_set_capabilities(organization_id,permission_set_id,capability_id) VALUES($1,$2,$3)",[org,set,cap]);
