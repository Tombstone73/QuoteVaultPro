...
export type NumberingSettings = Readonly<{ revision: string; documents: readonly Readonly<{ kind: "quote" | "order"; prefix: string; nextNumber: string; nextDisplayNumber: string; status: "ready"; adoption: "native_v2" | "lazy_native_default" }>[]; sharedJobNumber: Readonly<{ owner: "order_number"; behavior: "order_display_number"; configurableSeparately: false }>; compatibility: Readonly<{ legacyQuoteOrder: "converged"; legacyInvoice: "compatibility_managed"; legacyPurchaseOrder: "compatibility_managed"; importedHistoricalDocuments: "preserved" }>; readiness: Readonly<{ status: "ready" | "migration_required" | "needs_attention"; reasons: readonly string[] }> }>;
