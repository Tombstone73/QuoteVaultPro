...
export type StripeRuntimeReadiness = Readonly<{ mode:"test"|"live"|"unknown";status:"ready"|"not_configured"|"webhook_not_ready"|"action_required";secretKeyConfigured:boolean;publishableKeyMode:"test"|"live"|"unknown"|"missing";webhook:"ready"|"missing"|"invalid";configurationOwner:"platform_managed";actionRequired:string }>;
