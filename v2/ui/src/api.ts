...
export type QuickBooksQueueActivity = Readonly<{jobId:string;subjectKind:"invoice"|"payment"|"refund";subjectId:string;displayNumber:string;customerName:string;amountCents:number|null;currency:string|null;state:"queued"|"processing"|"retry"|"succeeded"|"uncertain"|"blocked";attemptCount:number;lastError:string|null;updatedAt:string;completedAt:string|null;providerId:string|null;retryEligible:boolean}>;
