...
export const App = ({
  ...
  useEffect(() => {
    const applyBrowserLocation = () => {
      ...
      else if (location.page === "productBuilder") { setProductBuilderId(location.productId ?? ""); setNewProductBuilder(location.newProduct === true); }
