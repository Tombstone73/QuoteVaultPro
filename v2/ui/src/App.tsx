...
import { pushArtworkLocation, pushContactLocation, pushCustomerLocation, pushFulfillmentLocation, pushInvoiceLocation, pushOrderLocation, pushProductBuilderLocation, pushProductLocation, pushProductionLocation, pushProofingLocation, pushQuoteLocation, pushWorkspaceLocation, readWorkspaceLocation } from "./productRouting";
...
export const App = ({
  ...
  useEffect(() => {
    const applyBrowserLocation = () => {
      ...
      else if (location.page === "productBuilder") setProductBuilderId(location.productId ?? "");
