...
import { StripeSettingsWorkspace } from "./StripeSettingsWorkspace";
...
import { ShippingPricingSettingsWorkspace } from "./ShippingPricingSettingsWorkspace";
  ...
  return (
    ...
    >
      {page === "home" ? (
        ...
        <SettingsWorkspace salesTax={<SalesTaxSettingsWorkspace organizationId={organizationId} sessionScope={sessionScope} canConfigure={bootstrap.data?.capabilities.pricingConfigure === true} />} email={<EmailSettingsWorkspace organizationId={organizationId} sessionScope={sessionScope} canConfigure={bootstrap.data?.capabilities.communicationsConfigure === true} />} payments={<StripeSettingsWorkspace organizationId={organizationId} sessionScope={sessionScope} canConfigure={bootstrap.data?.capabilities.organizationConfigure === true} />} accounting={<QuickBooksSettingsWorkspace organizationId={organizationId} sessionScope={sessionScope} canConfigure={bootstrap.data?.capabilities.organizationConfigure === true} />} shipping={<ShippingPricingSettingsWorkspace organizationId={organizationId} sessionScope={sessionScope} canConfigure={bootstrap.data?.capabilities.fulfillmentShippingPrice === true} />} businessProfile={<OrganizationSettingsWorkspace organizationId={organizationId} sessionScope={sessionScope} canConfigure={bootstrap.data?.capabilities.organizationConfigure === true} section="business" />} documents={<OrganizationSettingsWorkspace organizationId={organizationId} sessionScope={sessionScope} canConfigure={bootstrap.data?.capabilities.organizationConfigure === true} section="documents" />} numbering={<NumberingSettingsWorkspace organizationId={organizationId} sessionScope={sessionScope} canConfigure={bootstrap.data?.capabilities.numberingConfigure === true} />} staff={<TeamAccessWorkspace organizationId={organizationId} sessionScope={sessionScope} canView={bootstrap.data?.capabilities.permissionsView === true} canManageSets={bootstrap.data?.capabilities.permissionsManageSets === true} canAssignStaff={bootstrap.data?.capabilities.permissionsAssignStaff === true} canAssignPortal={bootstrap.data?.capabilities.permissionsAssignPortal === true} section="staff" openCustomers={() => { pushCustomerLocation(); setCustomerId(""); setPage("customers"); }} />} permissionSets={<TeamAccessWorkspace organizationId={organizationId} sessionScope={sessionScope} canView={bootstrap.data?.capabilities.permissionsView === true} canManageSets={bootstrap.data?.capabilities.permissionsManageSets === true} canAssignStaff={bootstrap.data?.capabilities.permissionsAssignStaff === true} canAssignPortal={bootstrap.data?.capabilities.permissionsAssignPortal === true} section="permission-sets" openCustomers={() => { pushCustomerLocation(); setCustomerId(""); setPage("customers"); }} />} portalAccess={<TeamAccessWorkspace organizationId={organizationId} sessionScope={sessionScope} canView={bootstrap.data?.capabilities.permissionsView === true} canManageSets={bootstrap.data?.capabilities.permissionsManageSets === true} canAssignStaff={bootstrap.data?.capabilities.permissionsAssignStaff === true} canAssignPortal={bootstrap.data?.capabilities.permissionsAssignPortal === true} section="portal" openCustomers={() => { pushCustomerLocation(); setCustomerId(""); setPage("customers"); }} />} />
      ) : page === "formulas" ? (
        ...
        <CustomerWorkspace
          ...
          canManageShipping={bootstrap.data?.capabilities.fulfillmentShippingPrice === true}
          openCustomer={(id) => {
        ...
        <FulfillmentWorkspace
          ...
          canView={bootstrap.data?.capabilities.fulfillmentView === true}
           ...
           canManageShippingCost={bootstrap.data?.capabilities.fulfillmentShippingCost === true}
           canManageShippingPrice={bootstrap.data?.capabilities.fulfillmentShippingPrice === true}
