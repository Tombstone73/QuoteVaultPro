...
client.setQueryData(["v2","scope-a","org-a","prepress","queue",1,25,""],{items:[{orderId:"order-a",orderNumber:"ORD-1007",customerId:"customer-a",customerDisplayName:"3 Alarm Graphics",orderLineId:"line-a",lineDescription:"Sign Vinyl",quantity:2,requestedDueDate:"2026-08-29",routingStepKind:"prepress",coverage:{state:"configured",productionArtworkComplete:true,allRequiredPrepressUnitsComplete:false,requirements:[{requirement:{key:"front",side:"front",sourcePageIndex:0,layerKey:"ink",layerOrder:0},artworkAssignmentIds:["assignment-a"],productionArtworkCovered:true,prepressComplete:false,prepressUnits:[{prepressUnitId:"unit-a",organizationId:"org-a",orderId:"order-a",orderLineId:"line-a",artworkAssignmentId:"assignment-a",artworkFileId:"file-a",side:"front",sourcePageIndex:0,layerKey:"ink",layerOrder:0,createdAt:"2026-08-25",createdPrincipalKind:"staff",createdPrincipalSubject:"staff-a"}]}]}}],pagination:{page:1,pageSize:25 as const,totalCount:1,totalPages:1}});
