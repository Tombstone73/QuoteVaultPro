...
export type WorkspaceLocation = Readonly<{ page: "home" }> | Readonly<{ page: "products"; productId?: string }> | Readonly<{ page: "productBuilder"; productId?: string; newProduct?: true }> | Readonly<{ page: "customers"; customerId?: string }> | Readonly<{ page: "contacts"; contactId?: string }> | Readonly<{ page: "quotes"; quoteId?: string; newQuote?: true }> | Readonly<{ page: "orders"; orderId?: string }> | Readonly<{ page: "inboundOrders" }> | Readonly<{ page: "invoices"; invoiceId?: string }> | Readonly<{ page: "fulfillment"; orderId?: string }> | Readonly<{ page: "production"; station?: "flatbed" | "roll"; productionWorkId?: string }> | Readonly<{ page: "artwork"; artworkFileId?: string; orderId?: string; lineId?: string }> | Readonly<{ page: "proofing"; proofWorkId?: string; orderId?: string; lineId?: string }> | Readonly<{ page: "prepress"; lineId?: string; prepressUnitId?: string }> | Readonly<{ page: "appearance" | "routing" | "payments" | "formulas" | "assistant" | "settings" }>;
...
export const readWorkspaceLocation = (pathname = window.location.pathname): WorkspaceLocation | null => {
  ...
  const page = pathname.replace(/^\/+|\/+$/gu, "");
  return page === "appearance" || page === "routing" || page === "payments" || page === "formulas" || page === "assistant" || page === "settings" ? { page } : null;
};
...
export const workspacePath = (page: "appearance" | "routing" | "payments" | "artwork" | "proofing" | "prepress" | "formulas" | "assistant" | "settings") => `/${page}`;
export const pushWorkspaceLocation = (page: "appearance" | "routing" | "payments" | "artwork" | "proofing" | "prepress" | "formulas" | "assistant" | "settings") => window.history.pushState({}, "", workspacePath(page));
