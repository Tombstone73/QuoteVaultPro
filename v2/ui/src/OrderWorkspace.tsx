...
export const OrderWorkspace = (props: Readonly<{
  organizationId: string; sessionScope: string; orderId: string; canEdit: boolean; canOverridePrice: boolean; canViewInvoice: boolean; canViewArtwork: boolean; csrfReady: boolean;
  onBack: () => void; openCustomer?: (customerId: string) => void; openFulfillment?: (orderId: string) => void; openInvoice?: (invoiceId: string) => void; openArtwork?: (orderId: string, lineId: string) => void; openQuote?: (quoteId: string) => void;
}>) => {
