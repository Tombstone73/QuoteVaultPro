...
export const SettingsWorkspace = ({ salesTax, email, payments, accounting, businessProfile, documents, numbering, staff, permissionSets, portalAccess }: Readonly<{ salesTax: ReactNode; email: ReactNode; payments: ReactNode; accounting: ReactNode; businessProfile: ReactNode; documents: ReactNode; numbering: ReactNode; staff: ReactNode; permissionSets: ReactNode; portalAccess: ReactNode }>) => {
