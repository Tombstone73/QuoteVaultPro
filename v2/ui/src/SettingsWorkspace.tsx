...
export const SettingsWorkspace = ({ salesTax, email, businessProfile, documents, numbering, staff, permissionSets, portalAccess }: Readonly<{ salesTax: ReactNode; email: ReactNode; businessProfile: ReactNode; documents: ReactNode; numbering: ReactNode; staff: ReactNode; permissionSets: ReactNode; portalAccess: ReactNode }>) => {
  ...
  const content = section === "overview" ? <Overview select={select} /> : section === "sales-tax" ? salesTax : section === "email" ? email : section === "business-profile" ? businessProfile : section === "documents" ? documents : section === "numbering" ? numbering : section === "staff" ? staff : section === "permission-sets" ? permissionSets : section === "portal-access" ? portalAccess : <Future title={all.find((item) => item.id === section)?.label ?? "Settings"} />;
