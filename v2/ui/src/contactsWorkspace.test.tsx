...
const list = renderToStaticMarkup(<QueryClientProvider client={listClient}><ContactsWorkspace organizationId="org-a" sessionScope="scope-a" contactId="" canView canEdit openContact={() => {}} openCustomer={() => {}} backToCatalog={() => {}} /></QueryClientProvider>);
...
const detail = renderToStaticMarkup(<QueryClientProvider client={detailClient}><ContactsWorkspace organizationId="org-a" sessionScope="scope-a" contactId="contact-a" canView canEdit openContact={() => {}} openCustomer={() => {}} backToCatalog={() => {}} /></QueryClientProvider>);
