    ...
    <section className="v2-quotes-list space-y-3 p-4">
      ...
      <div className="panel overflow-hidden v2-quotes-table-wrap">
        <table className="w-full border-collapse">
          <thead><tr>
            <th>Quote #</th><th>Customer</th><th>PO</th><th>Rep</th><th className="is-number">Lines</th><th>Due</th><th>Status</th><th className="is-number">Total</th>
          </tr></thead>
          <tbody>
            ...
            {!list.isLoading && rows.length === 0 && <tr><td colSpan={8} className="v2-quotes-empty">Nothing matches that filter.</td></tr>}
            {list.isLoading && <tr><td colSpan={8} className="v2-quotes-empty">Loading Quotes…</td></tr>}
          </tbody>
        </table>
      </div>
