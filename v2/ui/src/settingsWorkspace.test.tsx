...
const view = renderToStaticMarkup(<SettingsWorkspace salesTax={<p>Canonical tax</p>} email={<p>Canonical email</p>} payments={<p>Canonical payments</p>} accounting={<p>Canonical accounting</p>} shipping={<p>Canonical shipping</p>} businessProfile={<p>Canonical business</p>} documents={<p>Canonical documents</p>} numbering={<p>Canonical numbering</p>} staff={<p>Canonical staff</p>} permissionSets={<p>Canonical permission sets</p>} portalAccess={<p>Canonical portal access</p>} />);
