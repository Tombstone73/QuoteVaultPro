...
const tables = ["v2_billing_invoices", "v2_billing_invoice_lines", "v2_billing_invoice_checkpoints", "v2_billing_payments", "v2_billing_payment_allocations", "v2_billing_refunds", "v2_billing_refund_allocations", "v2_billing_refund_allocation_evidence", "v2_billing_provider_financial_operations", "v2_billing_provider_events"] as const;
const constraints = [
  ...
  "v2_billing_invoice_checkpoints_invoice_tenant_fk", "v2_billing_invoices_issued_actor_chk", "v2_billing_payments_invoice_fk", "v2_billing_payment_allocations_payment_fk", "v2_billing_payment_allocations_payment_invoice_uidx", "v2_billing_refunds_invoice_fk", "v2_billing_refund_allocations_payment_fk", "v2_billing_refund_allocation_evidence_payment_allocation_fk", "v2_billing_refund_allocation_evidence_refund_payment_allocation_uidx", "v2_billing_provider_ops_invoice_fk", "v2_billing_provider_financial_operations_allocation_intent_array_chk",
] as const;
const indexes = ["v2_billing_invoices_one_draft_per_order_uidx", "v2_billing_invoices_org_display_number_uidx", "v2_billing_invoice_lines_invoice_position_uidx", "v2_billing_invoice_checkpoints_invoice_org_uidx", "v2_billing_payments_invoice_idx", "v2_billing_payment_allocations_invoice_history_idx", "v2_billing_refunds_invoice_idx", "v2_billing_refund_allocation_evidence_invoice_history_idx", "v2_billing_provider_ops_external_tx_uidx"] as const;
const triggers = ["v2_billing_invoice_lifecycle_immutable_trigger", "v2_billing_invoice_line_lifecycle_immutable_trigger", "v2_billing_invoice_checkpoint_immutable_trigger", "v2_billing_payments_immutable_trigger", "v2_billing_payment_allocations_immutable_trigger", "v2_billing_refunds_immutable_trigger", "v2_billing_refund_allocations_immutable_trigger", "v2_billing_refund_allocation_evidence_immutable_trigger", "v2_billing_provider_events_immutable_trigger"] as const;
...
export async function checkV2BillingPhysicalPostconditions(client: TransactionalClient): Promise<BillingPhysicalPostcondition[]> {
  ...
  return [
    ...
    { id: "constraint:v2_billing_payment_allocations_payment_invoice_uidx", passed: constraintSet.has("v2_billing_payment_allocations_payment_invoice_uidx") && !constraintSet.has("v2_billing_payment_allocations_payment_uidx"), detail: "many Invoice allocations per Payment, with one allocation per Invoice" },
  ];
}
