...
const constraints = [
  ...
  "v2_billing_invoice_checkpoints_invoice_tenant_fk", "v2_billing_invoices_issued_actor_chk", "v2_billing_payments_invoice_fk", "v2_billing_payment_allocations_payment_fk", "v2_billing_payment_allocations_payment_invoice_uidx", "v2_billing_refunds_invoice_fk", "v2_billing_refund_allocations_payment_fk", "v2_billing_provider_ops_invoice_fk", "v2_billing_provider_financial_operations_allocation_intent_array_chk",
] as const;
const indexes = ["v2_billing_invoices_one_draft_per_order_uidx", "v2_billing_invoices_org_display_number_uidx", "v2_billing_invoice_lines_invoice_position_uidx", "v2_billing_invoice_checkpoints_invoice_org_uidx", "v2_billing_payments_invoice_idx", "v2_billing_payment_allocations_invoice_history_idx", "v2_billing_refunds_invoice_idx", "v2_billing_provider_ops_external_tx_uidx"] as const;
