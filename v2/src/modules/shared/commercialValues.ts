...
/** A post-fulfillment operational obligation; it never replaces an Order or handoff identity. */
export type ReplacementObligationId = Brand<string, "ReplacementObligationId">;
