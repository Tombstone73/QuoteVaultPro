...
export type ProductDraftFormulaPricing = Readonly<{ productId:string; draftVersionId:string; draftUpdatedAt:string; lifecycle:"draft"; source:"embedded_editable"|"library_product_inputs_editable"|"library_reference_read_only"|"unsupported_legacy"; editable:boolean; expressionEditable:boolean; variablesEditable:boolean; rotationEditable:boolean; inputs:readonly ProductFormulaInput[]; unavailableReason?:string; formulaId?:string; formulaName?:string; expression:string; variables:Readonly<Record<string,number>>; allowRotation:boolean; supportedRuntimeVariables:readonly string[]; warnings:readonly string[] }>;
export type UpdateProductDraftFormulaPricingInput = Readonly<{ productId:string; draftVersionId:string; expectedDraftUpdatedAt:string; businessRequestId:string; expression:string; variables:Readonly<Record<string,number>>; allowRotation:boolean }>;
