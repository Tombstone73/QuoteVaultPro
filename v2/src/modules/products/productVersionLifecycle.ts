...
export type ProductDraftFormulaPricing = Readonly<{ productId:string; draftVersionId:string; draftUpdatedAt:string; lifecycle:"draft"; source:"embedded_editable"|"library_reference_read_only"|"matrix_plus_formula_read_only"|"unsupported_legacy"; editable:boolean; unavailableReason?:string; formulaId?:string; formulaName?:string; expression:string; variables:Readonly<Record<string,number>>; supportedRuntimeVariables:readonly string[]; warnings:readonly string[] }>;
