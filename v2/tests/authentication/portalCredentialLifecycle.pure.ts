...
assert.match(ui, /const PasswordField/u);
assert.match(ui, /Show password/u);
assert.match(ui, /Hide password/u);
assert.match(ui, /portal-new-password/u);
assert.match(ui, /portal-current-password/u);
