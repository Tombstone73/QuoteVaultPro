...
assert.match(consoleUi, /2\. Sync Policy/);
assert.match(consoleUi, /Auto Sync:/);
assert.match(consoleUi, /3\. Import from QuickBooks/);
assert.match(consoleUi, /4\. Sync Invoices/);
assert.match(consoleUi, /5\. Sync Payments & Refunds/);
assert.match(consoleUi, /6\. Sync Queue \/ Activity/);
assert.match(consoleUi, /7\. Action Required/);
