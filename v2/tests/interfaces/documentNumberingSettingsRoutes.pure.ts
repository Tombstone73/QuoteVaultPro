...
const snapshot = { revision: "quote:1|order:1", documents: [{ kind: "quote", prefix: "QT-", nextNumber: "1000", nextDisplayNumber: "QT-1000", status: "ready" as const, adoption: "native_v2" as const }, { kind: "order", prefix: "ORD-", nextNumber: "1000", nextDisplayNumber: "ORD-1000", status: "ready" as const, adoption: "native_v2" as const }], sharedJobNumber: { owner: "order_number" as const, behavior: "order_display_number" as const, configurableSeparately: false }, compatibility: { legacyQuoteOrder: "migration_required" as const, legacyInvoice: "migration_required" as const, legacyPurchaseOrder: "migration_required" as const, importedHistoricalDocuments: "preserved" as const }, readiness: { status: "migration_required" as const, reasons: ["legacy"] } };
