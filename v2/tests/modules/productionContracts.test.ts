...
const projection:ProductionWorkProjection={work,attempts:[],completedGoodQuantity:0,recordedGoodQuantity:0,remainingGoodQuantity:100,unitQuantitySatisfied:false,state:"ready",exceptionEvents:[]};
...
assert.deepEqual(["production.view","production.work","production.complete","production.hold","production.rework","production.note"].every(x=>capabilityIds.includes(x as typeof capabilityIds[number])),true);
