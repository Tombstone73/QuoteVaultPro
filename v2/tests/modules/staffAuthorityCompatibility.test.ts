...
const expected = {
  owner: ["customer.view", "invoice.editDraft", "invoice.issue", "invoice.view", "order.cancel", "order.create", "order.edit", "order.view", "pricing.preview", "product.view", "quote.convert", "quote.create", "quote.edit", "quote.send", "quote.view"],
  admin: ["customer.view", "invoice.editDraft", "invoice.issue", "invoice.view", "order.cancel", "order.create", "order.edit", "order.view", "pricing.preview", "product.view", "quote.convert", "quote.create", "quote.edit", "quote.send", "quote.view"],
