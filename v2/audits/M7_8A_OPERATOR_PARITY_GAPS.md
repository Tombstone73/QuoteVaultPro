...
| P1-04 | Production | machine/printer selection and calendar controls; accepted-good rejection/scrap disposition | M7.8H closes Return-to-Prepress through an immutable successor cycle without rewinding the shared route; Cases A/B preserve accepted output and create only the remaining Prepress/Production obligation | decide any previously accepted-good rejection/scrap authority separately; separately decide whether scheduling is required |
...
| P1-12 | Production exceptions | previously accepted-good rejection/scrap disposition | M7.8H creates linked successor Prepress/Production work, keeps original route/attempt/output immutable, and blocks active Run reservations until member release | owner approval of an accepted-good reject/scrap authority; no silent quantity subtraction |
...
Production, Fulfillment, and Order lifecycle credit. Return-to-Prepress remains
an explicit, separate P1 owner decision.
