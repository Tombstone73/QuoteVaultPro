...
| P1-04 | Production | actual return-to-Prepress successor routing, machine/printer selection and calendar controls | M7.8G closes ordinary Run hold/release/cancel/successor recovery with canonical output reconciliation; it deliberately does not back-route shared line evidence to Prepress | approve a per-work rework-cycle/route authority; separately decide whether scheduling is required |
...
| P1-12 | Production exceptions | actual return-to-Prepress / revised-production-art successor | hold/resume, notes, `rework_requested`, and ordinary Run recovery are immutable and tenant-scoped; no Run state directly satisfies Production, Fulfillment, or Order lifecycle | owner approval of a per-work successor-cycle design; accepted-good correction stays a separate business decision |
