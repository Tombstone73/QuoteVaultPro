...
| Production | previously accepted-good rejection/scrap | V1 behavior not safely adopted | deliberately absent | OWNER DECISION REQUIRED | requires an attributed reject/scrap disposition; no silent quantity subtraction |
