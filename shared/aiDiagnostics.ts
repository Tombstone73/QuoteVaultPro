...
export const aiDiagnosticEnvelopeSchema = z.object({
  ...
  operatorRuntime: z.object({
    ...
    toolObservations: z.array(z.object({ toolName: safeText, status: safeText, failureCode: safeText.nullable().optional().default(null), failureCategory: safeText.nullable().optional().default(null), failingStep: safeText.nullable().optional().default(null), validationSchema: safeText.nullable().optional().default(null), validationIssuePaths: z.array(safeText).max(20).optional().default([]), validationIssueCodes: z.array(safeText).max(20).optional().default([]), operationType: safeText.nullable().optional().default(null) }).strict()).max(12).optional().default([]),
    firstFailedTool: z.object({ toolName: safeText, status: safeText, failureCode: safeText.nullable().optional().default(null), failureCategory: safeText.nullable().optional().default(null), failingStep: safeText.nullable().optional().default(null), validationSchema: safeText.nullable().optional().default(null), validationIssuePaths: z.array(safeText).max(20).optional().default([]), validationIssueCodes: z.array(safeText).max(20).optional().default([]), operationType: safeText.nullable().optional().default(null) }).strict().nullable().optional().default(null),
