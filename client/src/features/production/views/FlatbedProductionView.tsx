            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <input
                    type="checkbox"
                    id="flatbed-rp-noprints"
                    checked={reprintNoPrints}
                    onChange={(e) => setReprintNoPrints(e.target.checked)}
                    disabled={submitReprint.isPending}
                    className="h-4 w-4 rounded border-gray-300"
                  />
                  <label htmlFor="flatbed-rp-noprints" className="text-sm cursor-pointer select-none">No prints completed yet</label>
                </div>
                <div className="flex items-center gap-2">
                  <input
                    type="checkbox"
                    id="flatbed-rp-prepress"
                    ...
                    className="h-4 w-4 rounded border-gray-300"
                  />
                  <label htmlFor="flatbed-rp-prepress" className="text-sm cursor-pointer select-none">Send to Prepress for edits</label>
                </div>
              </div>
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-3">
          <div className="space-y-3">
            ...
            <Fact
              label="Lamination"
              value={
                <Badge variant={laminationLabel === "None" ? "outline" : "secondary"} className={laminationLabel === "None" ? "" : "bg-purple-100 text-purple-800 border-purple-300"}>
                  {laminationLabel}
                </Badge>
              }
            />
