...
export default function DailyProductionListPage() {
  ...
  return <main className="daily-production-report mx-auto max-w-6xl p-4 sm:p-6">{printStyles}
    ...
    {view === "overview" ? <ReportTable rows={report.overview} /> : <><ReportTable title="Roll Printing" rows={report.roll} /><ReportTable title="Flatbed Printing" rows={report.flatbed} /></>}
  </main>;
}
