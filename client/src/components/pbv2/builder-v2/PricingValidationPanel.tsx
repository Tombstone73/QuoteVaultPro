                ...
                <div className="mt-2 space-y-1 border-t border-slate-700/80 pt-2">
                  <section className="min-w-0">
                    ...
                    {openFormulaDebug ? (
                      ...
                      <div><span className="text-slate-400">Drop credit applied:</span> <span className="font-mono">{typeof formulaDebug.sheetYield?.billedSheetSqft === "number" && typeof formulaDebug.sheetYield?.sheetSqft === "number" && typeof formulaDebug.sheetYield?.totalSheetCount === "number" ? (formulaDebug.sheetYield.billedSheetSqft < formulaDebug.sheetYield.sheetSqft * formulaDebug.sheetYield.totalSheetCount ? "Yes" : "No") : "—"}</span></div>
