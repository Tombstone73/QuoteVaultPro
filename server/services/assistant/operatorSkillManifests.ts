...
const sourceConfig: Readonly<Record<OperatorDomain, Pick<OperatorSkillManifest, "knowledgeCompleteness" | "approvedSources" | "minimalGuidance">>> = {
  ...
  customers_contacts: { knowledgeCompleteness: "minimal", approvedSources: sources([["customer-pricing-tax", "customer-pricing-tax"]]), minimalGuidance: "Use live customer and contact records for current facts; do not infer commercial terms from names." },
