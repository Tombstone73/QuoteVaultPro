...
export const productParityInventory = Object.freeze([
  ...
  { id: "products.measurement", productArea: "Measurement mode", uiSource: source(productRoute, undefined, "PATCH /api/products/:id"), normalOperatorSource: source("server/services/products/canonicalProductConfigurationOperations.ts"), classification: "shared_canonical_today", notes: "Existing Product measurement mode is shared canonical." },
  ...
  { id: "products.option_groups_values", productArea: "Option groups and values", uiSource: source(productRoute, undefined, "PUT /api/products/:productId/pbv2/draft"), normalOperatorSource: source("server/services/products/canonicalPbv2OptionConfigurationOperations.ts"), classification: "shared_canonical_today", notes: "Group/input creation and metadata plus choice creation, labels, descriptions, and order share products.update_option_configuration.v1." },
