...
const uiOnlyInventory: CapabilityInventoryItem[] = [
  ...
  { id: "ui.products.activate_published_configuration", domain: "products", operation: "activate/deactivate one Product without publishing or changing its PBV2 pointer", mode: "mutation", uiExposure: "page_and_route", aiExposure: "command_plan_only", readToolName: null, commandName: "products.update_existing_product", inputSchemaSource: source("server/services/assistant/existingProductEditContract.ts", "existingProductEditOperationListSchema"), resultContractSource: source("server/services/products/canonicalProductLifecycleOperations.ts", "CanonicalProductLifecycleOperations"), permissionSource: source(productRoute, "isAdmin"), permissionRequirement: "admin", tenantScopingSource: source("server/services/products/canonicalProductLifecycleOperations.ts", "CanonicalProductLifecycleOperations"), confirmation: "go_required", idempotency: "server_generated_with_request_hash", lifecycleValidationSource: source("server/services/products/canonicalProductLifecycleOperations.ts", "CanonicalProductLifecycleOperations"), canonicalCandidate: source("server/services/products/canonicalProductLifecycleOperations.ts", "CanonicalProductLifecycleOperations"), routes: [source(productRoute, undefined, "PATCH /api/products/:id")], audit: source("server/services/products/canonicalProductLifecycleOperations.ts", "product_lifecycle_updated"), parity: "shared_canonical_today", migrationNotes: "Product Editor and the reviewed existing-Product GO command share products.update_lifecycle.v1; PBV2 publish and override administration remain separate UI-only lifecycle surfaces." },
