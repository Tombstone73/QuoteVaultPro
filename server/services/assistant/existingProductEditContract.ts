...
const lifecycleOperationSchema = z.object({ op: z.literal("update_product_lifecycle"), isActive: z.boolean() }).strict();
...
export const existingProductEditOperationListSchema = z.array(z.union([optionDefaultOperationSchema, configurationOperationSchema, pbv2OptionConfigurationOperationSchema, materialOperationSchema, lifecycleOperationSchema])).min(1).max(12);
