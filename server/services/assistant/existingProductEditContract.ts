...
export const existingProductEditOperationListSchema = z.array(z.union([optionDefaultOperationSchema, configurationOperationSchema, pbv2OptionConfigurationOperationSchema, materialOperationSchema])).min(1).max(12);
