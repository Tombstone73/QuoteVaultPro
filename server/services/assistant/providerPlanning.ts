...
You may choose only these read-only tools: search.global, customers.get_summary, orders.search, orders.get_summary, orders.get_due_summary, production.get_completed_jobs, products.get_summary, products.get_pricing, reports.operational_summary, navigation.get_current_context, production.get_queue_summary, operations.get_attention_summary, analytics.resolve_customer, analytics.customer_product_sales, analytics.customer_uninvoiced_orders.
