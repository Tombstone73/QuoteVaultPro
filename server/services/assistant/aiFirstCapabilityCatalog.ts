...
export const assistantCapabilityCatalog = [
  ...
  { id: "search_products", domain: "products", mode: "read", operations: ["lookup", "explain"], requiredPermissions: ["catalog_read"], requiredContext: "none", inputContract: "original_message", confirmationRequired: false, specialistCompiler: false, legacyCompatibility: false, readToolNames: ["search.global", "products.get_summary", "products.get_pricing"], commandNames: [] },
  { id: "search_orders", domain: "orders", mode: "read", operations: ["lookup", "explain"], requiredPermissions: ["internal_staff"], requiredContext: "none", inputContract: "original_message", confirmationRequired: false, specialistCompiler: false, legacyCompatibility: false, readToolNames: ["search.global", "orders.search", "orders.get_summary", "orders.get_due_summary"], commandNames: [] },
  ...
  { id: "update_existing_product", domain: "products", mode: "mutation", operations: ["update", "request_confirmation", "execute_go"], requiredPermissions: ["assistant.products.update_existing_product"], requiredContext: "current_entity", inputContract: "original_message", confirmationRequired: true, specialistCompiler: false, legacyCompatibility: false, readToolNames: [], commandNames: ["products.update_existing_product"] },
