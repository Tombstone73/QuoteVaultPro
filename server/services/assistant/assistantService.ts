    ...
    operations: {
      ...
      items: {
        oneOf: [
          ...
          { type: "object", additionalProperties: false, required: ["op", "detail"], properties: { op: { const: "record_unsupported_detail" }, detail: { const: "customer_specific_availability" } } },
