...
| capability.command.products.adjust_pricing | pricing | mutation | command | products.adjust_pricing | assistant.products.adjust_pricing | eligible | — | pricing.pbv2 | wrapped_existing |
| capability.command.products.rollback_pricing_change_set | pricing | mutation | command | products.rollback_pricing_change_set | assistant.products.adjust_pricing | eligible | — | pricing.pbv2 | wrapped_existing |
...
| capability.command.production.intake_line_items | production | mutation | command | production.intake_line_items | assistant.production.intake_line_items | eligible | — | production.operations | wrapped_existing |
| capability.command.production.send_to_prepress | production | mutation | command | production.send_to_prepress | assistant.production.send_to_prepress | eligible | — | production.operations | wrapped_existing |
| capability.command.production.update_job_status | production | mutation | command | production.update_job_status | assistant.production.update_job_status | eligible | — | production.operations | wrapped_existing |
| capability.command.production.add_job_note | production | mutation | command | production.add_job_note | assistant.production.add_job_note | eligible | — | production.operations | wrapped_existing |
| capability.command.fulfillment.create_shipment | fulfillment | mutation | command | fulfillment.create_shipment | assistant.fulfillment.create_shipment | eligible | — | fulfillment.operations | wrapped_existing |
| capability.command.fulfillment.update_shipment_details | fulfillment | mutation | command | fulfillment.update_shipment_details | assistant.fulfillment.update_shipment_details | eligible | — | fulfillment.operations | wrapped_existing |
| capability.command.fulfillment.mark_shipped | fulfillment | mutation | command | fulfillment.mark_shipped | assistant.fulfillment.mark_shipped | eligible | — | fulfillment.operations | wrapped_existing |
| capability.command.fulfillment.create_pickup_ticket | fulfillment | mutation | command | fulfillment.create_pickup_ticket | assistant.fulfillment.create_pickup_ticket | eligible | — | fulfillment.operations | wrapped_existing |
| capability.command.fulfillment.add_note | fulfillment | mutation | command | fulfillment.add_note | assistant.fulfillment.add_note | eligible | — | fulfillment.operations | wrapped_existing |
